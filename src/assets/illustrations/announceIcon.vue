    ...
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <defs>
            ...
            <linearGradient id="linear-gradient-3" x1="-755.66" y1="-7.43" x2="-616.77" y2="-182.04"
                gradientTransform="translate(-462.22 51.25) rotate(-172.52)" xlink:href="#linear-gradient">
            </linearGradient>
            ...
            <linearGradient id="linear-gradient-5" x1="126.13" y1="159.01" x2="120.16" y2="188.85"
                ...
                <stop offset="0.01" stop-color="#e5e7eb"></stop>
                <stop offset="1" stop-color="#e5e7eb" stop-opacity="0"></stop>
            </linearGradient>
        ...
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#60a5fa" opacity="0.18" style="isolation: isolate;"></path>
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#60a5fa"></path>
        <path
            d="M220.62,243.92l52.6,24a4.64,4.64,0,0,0,6.14-2.29l13.45-29.47a4.41,4.41,0,0,0,.42-1.75,4.65,4.65,0,0,0-2.7-4.4l-52.6-24a4.6,4.6,0,0,0-6.19,2.24l-13.46,29.49a4.63,4.63,0,0,0,2.28,6.15Z"
        ...
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#60a5fa"></path>
        <polygon points="273.05 194.09 256.94 151.77 214.44 168.28 268.94 201.46 273.05 194.09" fill="#60a5fa">
        </polygon>
        <path d="M231.55,205,248,241l44.61-9.11L276.5,189.57S232.75,204.38,231.55,205Z"
            transform="translate(-19.54 -37.78)" fill="url(#linear-gradient-2)"></path>
        ...
        <rect x="126.31" y="48.26" width="126.94" height="39.59" rx="15.26" fill="#e5e7eb"></rect>
        <rect x="147.74" y="92.48" width="126.94" height="39.59" rx="15.26" fill="#e5e7eb"></rect>
        <rect x="119.72" y="137.75" width="126.94" height="39.59" rx="15.26" fill="#e5e7eb"></rect>
        <path d="M176.27,195.6a15,15,0,1,1-15-15h0a14.92,14.92,0,0,1,15,14.84Z" transform="translate(-19.54 -37.78)"
            fill="#60a5fa" opacity="0.18" style="isolation: isolate;"></path>
        <circle cx="141.32" cy="156.54" r="4.44" fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></circle>
        <path d="M170.53,207.4a15,15,0,0,1-19.17-.54,10,10,0,0,1,19.17.54Z" transform="translate(-19.54 -37.78)"
            fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="171.57" y="146.11" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="171.57" y="152.98" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="171.57" y="159.85" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="171.57" y="166.72" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <ellipse cx="150.82" cy="246.31" rx="104.8" ry="12.77" fill="#60a5fa" opacity="0.18"
        ...
        <path d="M112.87,207.84v67.85s3.78,1.35,6.08,0l7.14-57.16,5,56.22s4,.94,7-.41l3-67S123.37,203.35,112.87,207.84Z"
            transform="translate(-19.54 -37.78)" fill="#991b1b"></path>
        <path
        ...
        <polygon points="109.16 141.25 116 119.24 84.38 127.09 101.69 151.19 109.16 141.25"
        ...
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#fcbdba"></path>
        <path d="M202,150.05a14.92,14.92,0,1,1,0-.16Z" transform="translate(-19.54 -37.78)" fill="#60a5fa"
            opacity="0.18" style="isolation: isolate;"></path>
        <circle cx="167.07" cy="110.99" r="4.44" fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></circle>
        <path d="M196.28,161.85a15,15,0,0,1-19.17-.54,10,10,0,0,1,19.17.54Z" transform="translate(-19.54 -37.78)"
            fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="197.32" y="100.56" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="107.43" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="114.3" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="121.17" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <path d="M182.16,105.83a15,15,0,1,1-15-15h0A15,15,0,0,1,182.16,105.83Z" transform="translate(-19.54 -37.78)"
            fill="#60a5fa" opacity="0.18" style="isolation: isolate;"></path>
        <circle cx="147.2" cy="66.78" r="4.44" fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></circle>
        <path d="M176.42,117.64a15,15,0,0,1-19.18-.55,10,10,0,0,1,19.18.55Z" transform="translate(-19.54 -37.78)"
            fill="#60a5fa" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="177.46" y="56.35" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="63.22" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="70.08" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="76.95" width="63.25" height="3.87" fill="#60a5fa" opacity="0.18"
            style="isolation: isolate;"></rect>
        <circle cx="246.47" cy="48.79" r="5.76" fill="#60a5fa"></circle>
        <path
