<template>
  <svg
    ...
    viewBox="80 80 80 185"
    class="h-full max-h-96 m-auto overflow-visible"
  >
    <!-- <defs>
        ...
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#7f1d1d" opacity="0.8" style="isolation: isolate;"></path>
        <path
        ...
        <path
            ...
            transform="translate(-19.54 -37.78)" fill="#7f1d1d"></path>
        <polygon points="273.05 194.09 256.94 151.77 214.44 168.28 268.94 201.46 273.05 194.09" fill="#7f1d1d">
        </polygon>
        ...
        <path d="M176.27,195.6a15,15,0,1,1-15-15h0a14.92,14.92,0,0,1,15,14.84Z" transform="translate(-19.54 -37.78)"
            fill="#7f1d1d" opacity="0.18" style="isolation: isolate;"></path>
        <circle cx="141.32" cy="156.54" r="4.44" fill="#7f1d1d" opacity="0.34" style="isolation: isolate;"></circle>
        <path d="M170.53,207.4a15,15,0,0,1-19.17-.54,10,10,0,0,1,19.17.54Z" transform="translate(-19.54 -37.78)"
            fill="#7f1d1d" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="171.57" y="146.11" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="171.57" y="152.98" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
    ...
    <path
      ...
      transform="translate(-19.54 -37.78)"
      fill="#7f1d1d"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M112.87,207.84v67.85s3.78,1.35,6.08,0l7.14-57.16,5,56.22s4,.94,7-.41l3-67S123.37,203.35,112.87,207.84Z"
      transform="translate(-19.54 -37.78)"
      fill="#991b1b"
    ></path>
    <path
    ...
    ></path>
    <polygon
      points="109.16 141.25 116 119.24 84.38 127.09 101.69 151.19 109.16 141.25"
    ...
    ></ellipse>
    <path
      d="M167.85,150.05l5.57,1.74v6l-5.62,2.06A24,24,0,0,1,167.85,150.05Z"
      transform="translate(-19.54 -37.78)"
      fill="url(#linear-gradient-7)"
    ></path>
    <path
      d="M157.11,165h3.47v3.05a1.74,1.74,0,0,1-1.74,1.74h0a1.74,1.74,0,0,1-1.74-1.74h0V165Z"
      transform="translate(-19.54 -37.78)"
      fill="#7f1d1d"
    ></path>
    ...
    <!-- <path d="M202,150.05a14.92,14.92,0,1,1,0-.16Z" transform="translate(-19.54 -37.78)" fill="#7f1d1d"
        ...
        <path d="M196.28,161.85a15,15,0,0,1-19.17-.54,10,10,0,0,1,19.17.54Z" transform="translate(-19.54 -37.78)"
            fill="#7f1d1d" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="197.32" y="100.56" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="107.43" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="114.3" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="197.32" y="121.17" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <path d="M182.16,105.83a15,15,0,1,1-15-15h0A15,15,0,0,1,182.16,105.83Z" transform="translate(-19.54 -37.78)"
            fill="#7f1d1d" opacity="0.18" style="isolation: isolate;"></path>
        <circle cx="147.2" cy="66.78" r="4.44" fill="#7f1d1d" opacity="0.34" style="isolation: isolate;"></circle>
        <path d="M176.42,117.64a15,15,0,0,1-19.18-.55,10,10,0,0,1,19.18.55Z" transform="translate(-19.54 -37.78)"
            fill="#7f1d1d" opacity="0.34" style="isolation: isolate;"></path>
        <rect x="177.46" y="56.35" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="63.22" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="70.08" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <rect x="177.46" y="76.95" width="63.25" height="3.87" fill="#7f1d1d" opacity="0.18"
            style="isolation: isolate;"></rect>
        <circle cx="246.47" cy="48.79" r="5.76" fill="#7f1d1d"></circle>
        <path
