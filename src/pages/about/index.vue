<template>
  <div
    class="max-w-screen-2xl mb-8 mt-2 px-8 grid gap-8 grid-cols-1 lg:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto backdrop-blur bg-red-600/30 text-gray-200 rounded-lg shadow-lg"
  >
    <div class="flex flex-col">
      <div>
        ...
        <div class="mt-8 text-sm text-center">
          Need to get in touch with us? Either fill out the form so we will
          contact you, or send us an email at
          <span class="underline select-text"> victoryads.srd@gmail.com</span>
        </div>
      </div>
