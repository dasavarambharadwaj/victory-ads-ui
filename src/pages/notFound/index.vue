  ...
  >
    ...
    >
      <div class="max-w-md text-center">
        ...
        <p class="text-2xl font-semibold">Sorry, we couldn't find this page.</p>
        <p class="mt-4 mb-8 dark:text-gray-400">
          But dont worry, you can find plenty of other things on our homepage.
        </p>
        <router-link to="/" class="flex flex-col items-center">
          <button
            class="mt-2 rounded-md bg-transparent px-8 py-4 font-medium transition-colors bg-gray-200 hover:text-blue-700 text-gray-900 disabled:opacity-50"
          >
            Back to homepage
          </button>
        </router-link>
