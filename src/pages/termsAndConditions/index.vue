<template>
  <div class="p-4 m-auto max-w-5xl">
    <h1 class="text-center text-xl font-bold mt-4 mb-2">Overview</h1>
    <p>
      This policy sets forth the general guidelines and acceptable and
      prohibited uses of the
      <a
        target="_blank"
        class="text-blue-500"
        rel="nofollow"
        href="https://victoryads-srd.in"
        >victoryads-srd.in</a
      >
    ...
    <div class="bg-gray-200 text-gray-900 rounded-md p-2">
      <h2 class="text-lg font-bold text-center mt-4 mb-2 inline">NOTE:</h2>
      <p class="inline pl-2">
        ...
        decisions. Any reliance on the material on this site is at your own
        risk.
      </p>
    </div>
    ...
    <div class="pl-2">
      <p>
        You may not use the Website and Services to engage in activity that is
        illegal under applicable law, that is harmful to others, or that would
        subject us to liability, including, without limitation, in connection
        with any of the following, each of which is prohibited under this
        Policy:
      </p>
      <ul class="list-decimal list-inside">
        ...
        <li>
          Collecting, or attempting to collect, information from the website
        </li>
      </ul>
    </div>
    <h2 class="text-lg font-bold text-center mt-4 mb-2">System abuse</h2>
    <div class="pl-2">
      <p>
    ...
    <h2 class="text-lg font-bold text-center mt-4 mb-2">Service resources</h2>
    <div class="pl-2">
      <p>
    ...
    <h2 class="text-lg font-bold text-center mt-4 mb-2">Copyrighted content</h2>
    <div class="pl-2">
      <p>
    ...
    <h2 class="text-lg font-bold text-center mt-4 mb-2">Enforcement</h2>
    <div class="pl-2">
      <p>
    ...
    <h2 class="text-lg font-bold text-center mt-4 mb-2">Contacting us</h2>
    <div class="pl-2">
      <p>
      ...
      <p>
        <a
          ...
          rel="nofollow"
          class="text-blue-500"
          href="https://victoryads-srd.in/terms-and-conditions"
          >https://victoryads-srd.in/about</a
        >
      </p>
      <p>This document was last updated on June 24, 2022</p>
    </div>
  </div>
</template>
